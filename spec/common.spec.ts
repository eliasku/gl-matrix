...
describe("common", function () {
  ...
  describe("equals", function () {
    ...
    it("should return false for numbers that are close but tolerance is set to smaller value", function () {
      expect(r3).toBe(false);
    });
    it("should return true for numbers that are close with tolerance is set to bigger value", function () {
      expect(r4).toBe(true);
    });
  });
});
